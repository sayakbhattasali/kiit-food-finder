...
public final class FavoriteDao_Impl implements FavoriteDao {
  ...
  public FavoriteDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfFavoriteEntity = new EntityInsertionAdapter<FavoriteEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `favorites` (`store_id`,`saved_at`) VALUES (?,?)";
      }

      @Override
      protected void bind(@NonNull final SupportSQLiteStatement statement,
          @NonNull final FavoriteEntity entity) {
        statement.bindLong(1, entity.getStoreId());
        statement.bindLong(2, entity.getSavedAt());
      }
    };
    this.__preparedStmtOfDeleteById = new SharedSQLiteStatement(__db) {
      ...
      public String createQuery() {
        final String _query = "DELETE FROM favorites WHERE store_id = ?";
        return _query;
      }
    };
  }
  ...
  @Override
  public Object deleteById(final int storeId, final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
  ...
  public Flow<List<FavoriteEntity>> observeAll() {
    final String _sql = "SELECT * FROM favorites ORDER BY saved_at DESC";
      ...
      public List<FavoriteEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            final int _tmpStoreId;
            _tmpStoreId = _cursor.getInt(_cursorIndexOfStoreId);
            final long _tmpSavedAt;
            _tmpSavedAt = _cursor.getLong(_cursorIndexOfSavedAt);
            _item = new FavoriteEntity(_tmpStoreId,_tmpSavedAt);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Object getAllIds(final Continuation<? super List<Integer>> $completion) {
    final String _sql = "SELECT store_id FROM favorites";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
  ...
  @Override
  public Object isFavorite(final int storeId, final Continuation<? super Boolean> $completion) {
    final String _sql = "SELECT EXISTS(SELECT 1 FROM favorites WHERE store_id = ?)";
